import 'dart:io';
import 'package:todosqflite/models/note.dart';
...
class Databasetodo{
  static final Databasetodo instance =Databasetodo._instance();
  static Database? _db = null;
  Databasetodo._instance();
  ...
  Future<Database?> get db async{
   ...
   void _createDb(Database db, int version) async{
    await db.execute(
      'CREATE TABLE $noteTable($colId INTEGER PRIMARY KEY AUTOINCREMENT,$colTitle TEXT,$colDate TEXT,$colStatus INTEGER)'
    );
   }
